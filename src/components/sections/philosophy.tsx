      ...
      <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
        ...
        <div>
          ...
          <p className="text-muted-foreground leading-relaxed text-base mb-4">
            ...
            menempuh pendidikan, pimpinan pondok berkomitmen menghadirkan ruang
            belajar yang lebih terbuka bagi siswa-siswi dan santri-santriwati.
          </p>
          <p className="text-muted-foreground leading-relaxed text-base mb-4">
            Karena itu, SMKIT Ushuluddin hadir dengan semangat pendidikan
            gratis, pendampingan yang dekat, dan lingkungan yang membentuk
            karakter — agar kesempatan belajar tidak berhenti pada keterbatasan
            biaya.
          </p>
          <p className="text-muted-foreground leading-relaxed text-base">
            Kuota 30 siswa per angkatan bukan untuk membatasi mimpi, tetapi agar
            setiap anak benar-benar mendapat perhatian yang layak.
          </p>
        </div>
        {/* Image column */}
